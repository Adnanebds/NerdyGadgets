                ...
                <div class="w-full px-4 mb-10 lg:w-1/2 lg:mb-0 ">
                    <div class="lg:max-w-md">
                        <div class="px-4 pl-4 mb-6 border-l-4 border-blue-500">
                            <span class="text-sm text-gray-600 uppercase dark:text-gray-400">Wie zijn wij?</span>
                        ...
                        <div class="flex flex-wrap items-center">
                            ...
                            <div class="w-full px-4 mb-6 sm:w-1/2 md:w-1/2 lg:mb-6">
                                <div class="p-6 bg-white dark:bg-gray-900">
                                    ...
                                    <h2 class="text-sm text-gray-700 dark:text-gray-400">geholpen mensen</h2>
                                </div>
                            </div>
                            <div class="w-full px-4 mb-6 sm:w-1/2 md:w-1/2 lg:mb-6">
                                <div class="p-6 bg-white dark:bg-gray-900">
                                    ...
                                    <h2 class="text-sm text-gray-700 dark:text-gray-400">Vrijwilligers</h2>
                                </div>
                            </div>
                            <div class="w-full px-4 mb-6 sm:w-1/2 md:w-1/2 lg:mb-6">
                                <div class="p-6 bg-white dark:bg-gray-900">
